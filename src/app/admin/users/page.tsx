                    ...
                    <div className="min-w-[1102px]">
                        <Table>
                            ...
                            <TableBody className="bg-[#0f172a]">
                                {usersData.map((user) => (
                                    <TableRow key={user.id} className="border-b border-gray-800 hover:bg-[#1e293b]">
                                            ...
                                            <div className="flex space-x-2">
                                                <button className="p-1.5 text-blue-400 rounded-md hover:bg-[#1e293b]">
                                                    <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M13.75 4.375L16.25 6.875L13.75 4.375ZM5 15H2.5V12.5L11.875 3.125C12.0408 2.95924 12.2704 2.86377 12.5 2.86377C12.7296 2.86377 12.9592 2.95924 13.125 3.125L16.875 6.875C17.0408 7.04076 17.1362 7.27038 17.1362 7.5C17.1362 7.72962 17.0408 7.95924 16.875 8.125L7.5 17.5H5V15Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                    </svg>
                                                </button>
                                                <button className="p-1.5 text-red-400 rounded-md hover:bg-[#1e293b]">
                                                    <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M16.875 4.375L3.125 4.375" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            ...
                            <div className="flex items-center space-x-2">
                                {[1, 2, 3].map((page) => (
                                    <button
                                        ...
                                        className={`flex items-center justify-center w-9 h-9 rounded-md ${currentPage === page
